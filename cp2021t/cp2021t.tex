...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mid \Varid{op}\equiv \Conid{Product}\mathrel{\wedge}(\Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{\vee}\Varid{b}\equiv (\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Conid{N}\;\mathrm{0},\Conid{N}\;\mathrm{0})))){}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{cataNonEmptyList}\;\Varid{g}{}\<[22]%
\>[22]{}\mathrel{=}\Varid{g}\comp \Varid{recList}\;(\Varid{cataNonEmptyList}\;\Varid{g})\comp \Varid{outNonEmptyList}{}\<[E]%
\\[\blanklineskip]%
