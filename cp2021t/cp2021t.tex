...
\\
\>[9]{}\hsindent{26}{}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{Product}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{y2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{y1}\;\Varid{x2}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\
\>[9]{}\hsindent{26}{}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{Product}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),(\Varid{eval\char95 exp}\;\Varid{v}\;(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;(\Conid{N}\;\Varid{y2}))\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\Varid{y1})\;\Varid{x2})))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Varid{op},(\Varid{x1},\Varid{x2})){}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{E}{}\<[49]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}i_1\;\underline{\Varid{p}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\;\Varid{l}\mathrel{=}i_2\;((\Varid{init}\;\Varid{l}),(\Varid{tail}\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
