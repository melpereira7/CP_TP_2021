...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 sum\char95 idr}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 sum\char95 idl}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 product\char95 idr}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 product\char95 idl}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 e\char95 id}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 negate\char95 id}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 double\char95 negate}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 optimize\char95 respects\char95 semantics}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 const\char95 rule}\mathbin{::}(\R\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 sum\char95 rule}\mathbin{::}(\R\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Conid{ExpAr}\;\Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 product\char95 rule}\mathbin{::}(\R\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Conid{ExpAr}\;\Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 e\char95 rule}\mathbin{::}(\R\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 negate\char95 rule}\mathbin{::}(\R\;\Varid{a},\Conid{Floating}\;\Varid{a})\Rightarrow \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{prop\char95 congruent}\mathbin{::}(\Conid{Floating}\;\Varid{a},\R\;\Varid{a})\Rightarrow \Varid{a}\to \Conid{ExpAr}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{ps'}\mathrel{=}[\mskip1.5mu \mathrm{0},\mathrm{0.01}\mathinner{\ldotp\ldotp}\mathrm{1}\mskip1.5mu]\mbox{\onelinecomment  interval}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Gloss:
\begin{hscode}\SaveRestoreHook
...
\\
\>[B]{}(\mathbin{\stackrel{\mathrm{?}}{=}})\mathbin{::}\R\;\Varid{a}\Rightarrow \Varid{a}\to \Varid{a}\to \Conid{Bool}{}\<[E]%
\\
...
%
  \ensuremath{\begin{lcbr}\Varid{out}\comp \underline{\Conid{X}}\mathrel{=}\Varid{id}\comp i_1\\\Varid{out}\comp \alt{\Conid{N}}{\Varid{ops}}\mathrel{=}\Varid{id}\comp i_2\end{lcbr}}
%
\just\equiv{ pelo enunciado : ops = either bin (uncurry Un) ; fusão-+ ; universal-+ }
%
  \left\{
    \begin{array}{lll}
      \ensuremath{\Varid{out}\comp \underline{\Conid{X}}\mathrel{=}\Varid{id}\comp i_1}\\
      \ensuremath{\Varid{out}\comp \Conid{N}\mathrel{=}\Varid{id}\comp i_2\comp i_1}\\
      \ensuremath{\Varid{out}\comp \alt{\Varid{bin}}{\uncurry{\Conid{Un}}}\mathrel{=}\Varid{id}\comp i_2\comp i_2}
    \end{array}
  \right
%
...
%
  \left\{
   \begin{array}{llll}
      \ensuremath{\Varid{out}\comp \underline{\Conid{X}}\mathrel{=}\Varid{id}\comp i_1}\\
      \ensuremath{\Varid{out}\comp \Conid{N}\mathrel{=}\Varid{id}\comp i_2\comp i_1}\\
      \ensuremath{\Varid{out}\comp \Varid{bin}\mathrel{=}\Varid{id}\comp i_2\comp i_2\comp i_1}\\
      \ensuremath{\Varid{out}\comp \uncurry{\Conid{Un}}\mathrel{=}\Varid{id}\comp i_2\comp i_2\comp i_2}
  \end{array}
  \right
%
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}}
           \ar[d]_-{\ensuremath{\cata{\Varid{g}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}\Conid{BinOp}\times} {\ensuremath{\Conid{ExpAr}}^2} \ensuremath{\mathbin{+}\Conid{UnOp}\times\Conid{ExpAr}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\mathbin{+}\Varid{id}\times} {\ensuremath{\cata{\Varid{g}}}^2} \ensuremath{\mathbin{+}\Varid{id}\times\cata{\Varid{g}}}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\Conid{F}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}\Conid{BinOp}\times} {\ensuremath{\Conid{F}}^2} \ensuremath{\mathbin{+}\Conid{UnOp}\times\Conid{F}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}}
           \ar[d]_-{\ensuremath{\Varid{eval\char95 exp}\mathrel{=}\cata{\Varid{g\char95 eval\char95 exp}}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\mathbin{+}\Conid{BinOp}\times} {\ensuremath{\Conid{ExpAr}}^2} \ensuremath{\mathbin{+}\Conid{UnOp}\times\Conid{ExpAr}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\mathbin{+}\Varid{id}\times} {\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}}}^2} \ensuremath{\mathbin{+}\Varid{id}\times\cata{\Varid{g\char95 eval\char95 exp}}}}
           \ar[l]_-{\ensuremath{\Varid{inExpAr}}}
\\
     \ensuremath{\Conid{F}}
&
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;()\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\Varid{b}\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Varid{op},(\Varid{x},\Varid{y})){}\<[25]%
\>[25]{}\mid \Varid{op}\equiv \Conid{Sum}\mathrel{=}\Varid{x}\mathbin{+}\Varid{y}{}\<[E]%
\\
\>[25]{}\mid \Varid{op}\equiv \Conid{Product}\mathrel{=}\Varid{x}\mathbin{*}\Varid{y}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Varid{op},\Varid{x}){}\<[25]%
\>[25]{}\mid \Varid{op}\equiv \Conid{Negate}\mathrel{=}\mathbin{-}\Varid{x}{}\<[E]%
\\
\>[25]{}\mid \Varid{op}\equiv \Conid{E}\mathrel{=}\Varid{expd}\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mid \Varid{op}\equiv \Conid{Product}\mathrel{\wedge}(\Varid{a}\equiv (\Conid{N}\;\mathrm{0})\mathrel{\vee}\Varid{b}\equiv (\Conid{N}\;\mathrm{0}))\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b})))){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;()\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\Varid{a}\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Varid{op},((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})))\mid \Varid{op}\equiv \Conid{Sum}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),(\Conid{Bin}\;\Varid{op}\;\Varid{y1}\;\Varid{y2})){}\<[E]%
\\
\>[9]{}\hsindent{26}{}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{Product}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),{}\<[E]%
\\
\>[35]{}\hsindent{4}{}\<[39]%
\>[39]{}(\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;\Varid{y2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{y1}\;\Varid{x2}))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Varid{op},(\Varid{x1},\Varid{x2})){}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{E}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Un}\;\Varid{op}\;\Varid{x1}),(\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{x1})\;(\Varid{x2}))){}\<[E]%
\\
\>[35]{}\mid \Varid{op}\equiv \Conid{Negate}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Un}\;\Varid{op}\;\Varid{x1}),(\Conid{Un}\;\Varid{op}\;\Varid{x2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;()\mathrel{=}(\Conid{X},\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\Varid{a}\mathrel{=}(\Conid{N}\;\Varid{a},\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g3}\;(\Varid{op},((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2})))\mid \Varid{op}\equiv \Conid{Sum}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),(\Varid{y1}\mathbin{+}\Varid{y2})){}\<[E]%
\\
\>[9]{}\hsindent{26}{}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{Product}\mathrel{=}((\Conid{Bin}\;\Varid{op}\;\Varid{x1}\;\Varid{x2}),(\Varid{eval\char95 exp}\;\Varid{v}\;(\Conid{Bin}\;\Conid{Sum}{}\<[E]%
\\
\>[35]{}\hsindent{6}{}\<[41]%
\>[41]{}(\Conid{Bin}\;\Conid{Product}\;\Varid{x1}\;(\Conid{N}\;\Varid{y2}))\;(\Conid{Bin}\;\Conid{Product}\;(\Conid{N}\;\Varid{y1})\;\Varid{x2})))){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g4}\;(\Varid{op},(\Varid{x1},\Varid{x2})){}\<[35]%
\>[35]{}\mid \Varid{op}\equiv \Conid{E}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Un}\;\Varid{op}\;\Varid{x1}),(\Varid{eval\char95 exp}\;\Varid{v}\;(\Conid{Un}\;\Conid{E}\;\Varid{x1}))\mathbin{*}\Varid{x2}){}\<[E]%
\\
\>[35]{}\mid \Varid{op}\equiv \Conid{Negate}{}\<[49]%
\>[49]{}\mathrel{=}((\Conid{Un}\;\Varid{op}\;\Varid{x1}),(\mathbin{-}\Varid{x2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\Varid{dividendo}\;\Varid{n})\mathbin{*}\Varid{c}\;(\Varid{n})\mathbin{\Varid{`div`}}(\Varid{divisor}\;\Varid{n})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dividendo}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{dividendo}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{4}\mathbin{+}\Varid{dividendo}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divisor}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{divisor}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{divisor}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{dividendo},\Varid{divisor})\mathrel{=}(\Varid{dividendo}\mathbin{*}\Varid{c}\mathbin{\Varid{`div`}}\Varid{divisor},\mathrm{4}\mathbin{+}\Varid{dividendo},\mathrm{1}\mathbin{+}\Varid{divisor}){}\<[E]%
\\
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\R\times\Conid{NPoint}}
            \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{calcLine}}}
\\
     \ensuremath{\Conid{OverTime}\;\Conid{NPoint}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\R\times\Conid{OverTime}\;\Conid{NPoint}}
...
\>[B]{}\Varid{calcLine}\mathbin{::}\Conid{NPoint}\to (\Conid{NPoint}\to \Conid{OverTime}\;\Conid{NPoint}){}\<[E]%
\\
\>[B]{}\Varid{calcLine}\mathrel{=}\Varid{cataList}\;\alt{\Varid{h1}}{\Varid{h2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h1}\;()\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h2}\;(\Varid{p},\Varid{x})\mathrel{=}{}\<[17]%
\>[17]{}\overline{\Varid{g}}\;\Varid{p}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}(\Varid{x}\mathbin{:}\Varid{xs})\to \lambda \Varid{z}\to \Varid{concat}\mathbin{\$}(\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{d}\;\Varid{x},\Varid{f}\;\Varid{xs}\mskip1.5mu])\;\Varid{z}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    {\ensuremath{\Conid{NPoint}}^*}
           \ar[d]_-{\ensuremath{\ana{\Varid{coalg}}}}
            \ar[r]^-{\ensuremath{\Varid{coalg}}}
&
    \ensuremath{\Conid{NPoint}\mathbin{+}} {\ensuremath{\Conid{NPoint}}^*^2}
            \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}} {\ensuremath{\ana{\Varid{coalg}}}^2}}
\\
     {\ensuremath{\Conid{NPoint}}^*}
...
&
     \ensuremath{\Conid{NPoint}\mathbin{+}} {\ensuremath{\Conid{NPoint}}^*^2}
           ...
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}} {\ensuremath{\cata{\Varid{alg}}}^2}}
\\
     \ensuremath{\Conid{OverTime}\;\Conid{NPoint}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\R\times\Conid{OverTime}\;\Conid{NPoint}}
           \ar[l]^-{\ensuremath{\Varid{alg}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}i_1\;\underline{\Varid{p}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\;\Varid{l}\mathrel{=}i_2\;((\Varid{init}\;\Varid{l}),(\Varid{tail}\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g1}\;\Varid{l}\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g2}\;(\Varid{l1},\Varid{l2})\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;(\Varid{l1}\;\Varid{pt})\;(\Varid{l2}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=2cm{
&     {\ensuremath{\Conid{A}}^*}
           \ar[ld]_-{\ensuremath{\Varid{avg}}}
           \ar[d]_{\ensuremath{\conj{\Varid{avg}}{\length }}}
           \ar[rd]^-{\ensuremath{\length }}
\\
      \ensuremath{\R}
&
      \ensuremath{\R\times}{\ensuremath{\N}^+}
           \ar[l]^-{\ensuremath{\p1}}
           \ar[r]^-{\ensuremath{\p2}}
&
      {\ensuremath{\N}^+}
...
\xymatrix@C=2cm{
    {\ensuremath{\Conid{A}}^*}
           \ar[d]_-{\ensuremath{\cata{\alt{\Varid{b}}{\Varid{q}}}\mathrel{=}\conj{\Varid{avg}}{\length }}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times}{\ensuremath{\Conid{A}}^*}
            \ar[l]_{\ensuremath{\mathbf{in}}}
            \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length }}}
\\
     \ensuremath{\R\times}{\ensuremath{\N}^+}
&
     \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\R\times}{\ensuremath{\N}^+}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outNonEmptyList}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[23]%
\>[23]{}\mathrel{=}i_1\;(\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{outNonEmptyList}\;(\Varid{a}\mathbin{:}\Varid{x})\mathrel{=}i_2\;(\Varid{a},\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataNonEmptyList}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recList}\;(\Varid{cataNonEmptyList}\;\Varid{g})\comp \Varid{outNonEmptyList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataNonEmptyList}\;\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g1}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{g2}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}((\Varid{a}\mathbin{+}\Varid{c}\mathbin{*}\Varid{b})\mathbin{/}(\Varid{c}\mathbin{+}\mathrm{1}),\Varid{c}\mathbin{+}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
           \ar[d]_-{\ensuremath{\cata{\alt{\Varid{b}}{\Varid{q}}}\mathrel{=}\conj{\Varid{avg}}{\length }}}
&
    \ensuremath{\Conid{A}\mathbin{+}}{(\ensuremath{\mathsf{LTree}\;\Conid{A}})^2}
            \ar[l]_{\ensuremath{\mathbf{in}}}
            \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}}{\ensuremath{\cata{\alt{\Varid{b}}{\Varid{q}}}}^2}}
\\
     \ensuremath{\R\times}{\ensuremath{\N}^+}
&
     \ensuremath{\Conid{A}\mathbin{+}}{(\ensuremath{\R\times} {\ensuremath{\N}^+})^2}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{g1}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{1}){}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{g2}\;((\Varid{a1},\Varid{b1}),(\Varid{a2},\Varid{b2}))\mathrel{=}((\Varid{a1}\mathbin{*}\Varid{b1}\mathbin{+}\Varid{a2}\mathbin{*}\Varid{b2})\mathbin{/}(\Varid{b1}\mathbin{+}\Varid{b2}),\Varid{b1}\mathbin{+}\Varid{b2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
